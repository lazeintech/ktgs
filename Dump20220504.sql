...
CREATE TABLE `job_assignments` (
  `classCode` varchar(45) NOT NULL,
  `job1` varchar(45) NOT NULL,
  `job2` varchar(45) NOT NULL,
  `job3` varchar(45) NOT NULL,
  `job4` varchar(45) NOT NULL,
  `job5` varchar(45) NOT NULL,
  `job6` varchar(45) NOT NULL,
  PRIMARY KEY (`classCode`),
  UNIQUE KEY `class_UNIQUE` (`classCode`),
  CONSTRAINT `class` FOREIGN KEY (`classCode`) REFERENCES `classes` (`classCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `job_assignments` VALUES ('NCS26-TPH','test','test','test','test','test','test'),('TEST-CLASS','test','test','test','test','test','test');
...
-- Dump completed on 2022-05-04 10:21:32
